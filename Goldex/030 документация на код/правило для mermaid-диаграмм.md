...
> **использовать `classDiagram`** с описанием классов в форме `class NAME["LABEL"]` (без `as`), чтобы избежать ошибки `Expecting 'ALPHA'... got 'STR'` при наличии кавычек в названии.